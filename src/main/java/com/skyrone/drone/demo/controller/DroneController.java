...
public class DroneController {
    ...
    public void makeRandomData() {
        for (int i = 0; i < 30; i++) {
            int random = ThreadLocalRandom.current().nextInt(3154, 9399);
            int code = 1000 + i * 21;
            Drone drone = new Drone("mavic"+code,"Mavic plus max 2020"+random, "Mavic", "white", "1.1x0.95x0.8 m", 19000, 35, 90, 290, 155000);
